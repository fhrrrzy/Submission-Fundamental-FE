class CharacterItem extends HTMLElement{
    ...
    render(){
        this.innerHTML = `
        <div class="flex items-center w-full gap-3 p-3 border-[1px] rounded-lg mb-1 hover:bg-slate-900 duration-150 border-slate-600 cursor-pointer" data-id="${this._character.id}">
